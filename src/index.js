            ...
            <Animated.View style={[styles.container, translateStyles]}>
                {
                    ...
                    ?
                        <>
                            <View style={[styles.ball, {width: 800, borderRadius: 1000}]}>
                                <View style={{position: 'absolute', bottom: 20, width: 120, height: 120, justifyContent: 'center', alignItems: 'center'}}>
                                    <Image
                                        source={{uri: 'https://blogs.tees.ac.uk/lteonline/files/2019/02/teamssocial-noresize.png'}}
                    ...
                    :
                        <>
                            <View style={[styles.ball, {left: -180, top: -180, width: 350, height: 350, borderRadius: 500}]}>
